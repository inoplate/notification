...
$router->group(['prefix' => 'admin', 'middleware' => ['auth']], function($router){
    ...
    $router->group(['middleware' => ['authorize:notification']], function($router){
        $router->put('inoplate-notification/notifications/{notification}/mark-as-viewed', ['uses' => 'NotificationController@putMarkAsViewed', 'as' => 'notification.admin.notifications.mark-as-viewed.put']);
    });
});